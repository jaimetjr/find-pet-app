...
import { FilterOptions } from "./ActiveFilters"
...
export default function FilterModal({visible, onClose, filters, onApplyFilters, hasLocationPermission }: FilterModalProps) {
